...
describe('Service > Permissions', () => {
  ...
  describe('Check permissions expiration', () => {
    beforeEach(() => {
      PermissionsChecker.resetExpiration();
      PermissionsChecker.cleanCache();
      nock.cleanAll();
    ...
    it('should retrieve the permissions if last retrieve is null', (done) => {
    ...
    it('should re-retrieve the permissions if it is expired', (done) => {
    ...
    it('should not re-retrieve the permissions if it is not expired', (done) => {
